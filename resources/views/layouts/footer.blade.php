    ...
    <div class="container pt-70 pb-40">
        <div class="row border-bottom-black">
            <div class="col-sm-6 col-md-3">
                <div class="widget dark"> <img alt=""
                        src="{{ asset('assets/images/logo-wide-white-footer.png') }}">
                    <p class="font-13 mt-20 mb-10">HelpingPro is a non profit charity and crowdfunding
                        template with web elements which helps you to build your own charity or any non profit
                        templatesite <a class="text-theme-colored" href="#">read more</a> </p>
            ...
            <div class="col-sm-6 col-md-3">
                <div class="widget dark">
                    ...
                    <form id="footer_quick_contact_form" name="footer_quick_contact_form" class="quick-contact-form"
                        action="https://kodesolution.com/html/2017/helpingpro-html/demo/includes/quickcontact.php"
                        method="post">
                        ...
                        <div class="form-group">
                            <textarea id="form_message" name="form_message" class="form-control" required="" placeholder="Enter Message"
                                rows="3"></textarea>
                        </div>
                        <div class="form-group">
